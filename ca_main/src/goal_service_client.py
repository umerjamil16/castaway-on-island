...
bb8_move_srv_client = rospy.ServiceProxy('/get_robot_1_goal', GoalCustomSrv)
...
rospy.loginfo("Goal Recieved: Goal_x: " + str(result.x) + " Goal_y: " + str(result.y)+ " Yaw: " + str(result.t))
